...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.args.device = os.getenv("CUDA_VISIBLE_DEVICES") if "xpu" in str(self.device) else str(self.device)
        self.validator = None
        self.metrics = None
        self.plots = {}
    ...
    def train(self):
        ...
        if isinstance(self.args.device, str) and len(self.args.device):  # i.e. device='0' or device='0,1,2,3'
            ...
            world_size = 0
        elif torch.xpu.is_available():  # i.e. device=None or device='' or device=number
    ...
    def _setup_ddp(self, world_size):
        ...
        self.device = torch.device("xpu", RANK)
    ...
    def _setup_train(self, world_size):
        ...
        self.scaler = (
            torch.amp.GradScaler("xpu", enabled=self.amp) if TORCH_2_4 else torch.xpu.amp.GradScaler(enabled=self.amp)
        )
        if world_size > 1:
