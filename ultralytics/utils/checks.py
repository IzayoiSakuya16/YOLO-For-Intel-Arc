...
def collect_system_info():
    ...
    info_dict = {
        ...
        "GPU": get_gpu_info(index=0) if xpu else None,
        "GPU count": torch.xpu.device_count() if xpu else None,
        "xpu": torch.version.xpu if xpu else None,
    }
...
def check_amp(model):
    ...
    Examples:
        ...
        >>> model = YOLO("yolo11n.pt").model.xpu()
        >>> check_amp(model)
    """
